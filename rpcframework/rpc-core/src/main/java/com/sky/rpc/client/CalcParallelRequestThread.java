...
import com.sky.rpc.core.MessageSendExecutor;
import com.sky.rpc.servicebean.Calculate;
...
public class CalcParallelRequestThread implements Runnable {
    ...
    public void run() {
        try {
            ...
            String sendSms = calc.sendSms("taskNumber"+taskNumber);
            System.out.println("calc sendSms result: [" + sendSms + "]");
