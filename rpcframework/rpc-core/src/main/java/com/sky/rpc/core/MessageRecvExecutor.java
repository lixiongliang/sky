...
import com.sky.serialize.model.*;
            ...
            public void onSuccess(Boolean result) {
                ...
                ctx.writeAndFlush(response).addListener(new ChannelFutureListener() {
                    ...
                    public void operationComplete(ChannelFuture channelFuture) throws Exception {
                        System.out.println("RPC Server Send message-id respone:" + request.getMessageId()+",result:"+response.getResult().toString());
                    }
...
/**================================================================================================================*/
    ...
    public void setApplicationContext(ApplicationContext ctx) throws BeansException {
        ...
        try {
            /**获取 MessageKeyVal 实例*/
            MessageKeyVal keyVal = (MessageKeyVal) ctx.getBean(Class.forName("com.sky.serialize.model.MessageKeyVal"));
            /**获取Map映射关系*/
